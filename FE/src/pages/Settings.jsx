...
// Map Key kỹ thuật của khảo sát sang nhãn tiếng Việt dễ đọc
const SURVEY_LABELS = {
                    ...
                    <section className="glass-card rounded-xl p-[40px]">
                        <div className="flex items-center gap-[16px] mb-[24px]">
                            ...
                            <div>
                                ...
                                <p className="text-[14px] text-[#45464d]">Trả lời khảo sát ngắn để AI hiểu bạn hơn và trả lời chính xác hơn.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-[16px] mb-[24px]">
                            <button
                                ...
                                className="px-[24px] py-[8px] bg-[#6b38d4] text-white rounded-lg text-[14px] font-medium hover:opacity-90 active:scale-95 transition-all flex items-center gap-[8px]"
                            >
                                <span className="material-symbols-outlined text-[18px]">tune</span>
                                Chỉnh sửa khảo sát cá nhân hóa
                            </button>
                        </div>
                                    ...
                                    <div key={m.id} className="flex justify-between items-start gap-[16px] p-[12px] bg-white border border-[#c6c6cd]/50 rounded-lg">
                                        <div className="min-w-0">
                                            <p className="text-[13px] font-semibold text-[#000000] truncate">
                                                {m.category === 'Survey' ? (SURVEY_LABELS[m.key] || m.key) : `${m.category} — ${m.key}`}
                                            </p>
