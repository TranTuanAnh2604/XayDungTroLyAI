            ...
            >
                ...
                <nav className="hidden md:flex w-[280px] h-full flex-col bg-[#eff4ff] border-r border-[#c6c6cd] fixed left-0 top-0 bottom-0 z-40">
                    ...
                    <div className="px-[16px] mb-[16px]">
                        <button onClick={() => navigate('/chat')} className="w-full flex items-center justify-center gap-[8px] bg-[#000000] text-white rounded-lg py-[8px] text-[14px] font-medium tracking-[0.01em] hover:bg-[#565e74] active:scale-95 transition-transform">
                            <span
                                className="material-symbols-outlined"
                                style={{ fontVariationSettings: "'FILL' 1" }}
                            >
